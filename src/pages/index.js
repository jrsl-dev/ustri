  ...
  <div class="block block--light row">
    ...
    <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 center">
      ...
      <p class="block__copy">
        ...
        the United States. Here you will find the history of both Tamiya Ryu and
        its history in the United States as well as information on where to find
        a dojo and how to join. We hope to see you on the dojo floor soon!
      </p>
      ...
      <ul class="news">
        ...
        <li class="news__item">
          <div class="card card--max-width row">
            ...
            <div class="col-xs-12 col-lg-5">
              <p class="card__body">Reflections on rejuvenation and renewal</p>
            </div>
            <div class="col-xs-12 col-lg-2 card__cta-container">
              <a
          ...
          <div class="card card--max-width row">
            ...
            <div class="col-xs-12 col-lg-5">
              <p class="card__body">
                ...
                Promotions/Honors that were achieved during the recent visit by
                15th Soke Tsumaki Kazuo Genwa and his Assistant, Endo Tsuyako
                Gentei Sensei. Everyone performed beyond our expectations and
                made not only the visiting Sensei proud but made our hearts
                swell to almost bursting.
              </p>

              <p class="card__body">
                Special Tamiya Ryu Iaijutsu Genwakai names (Gengo) were also
                awarded to our 3 new Godan members, as well as the honorific
                title "Kouga" to Dianne Genan Sensei. In a very surprising turn
                of events, Michael Alexanian Gennan Buhaku Sensei was elevated
                to the rank of Hachidan.
              </p>

              <p class="card__body">
                Soke Sensei also announced to our group the formation of the new
                USTRI Gengo Hojisha no Kai, with Gennan Buhaku Sensei to serve
                as the Kaicho (President) and Genan Sensei as the Fuku-kaicho
                (Vice President). This is truly a unifying step for both the
                Michigan Honbu Dojo and the Southeast Michigan Shibu as there
                are now 4 persons in each Branch that possess Gengo and can
                provide an equal presence and voice for Board Meetings, etc.
              </p>

              <p class="card__body">
                This year’s visit by the Sensei was a truly memorable one, and
                much was revived and renewed during their time here. Commitments
                were solidified, new pledges were made and long-term assignment
                were given, all to the delight of Soke Sensei and Endo Sensei
                and all who were involved to make this event truly "one for the
                books".
              </p>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 location-block">
          ...
          <div class="media media--center media--max-width">
            <img src="images/east-lansing-location.jpg" class="media__image" />
          ...
          <div class="col-xs-12">
            <div class="card__body">
              ...
              <p>
                ...
                <strong>Saturdays from 10:30am to 12:00pm</strong> at the Macomb
              ...
              <p>
                ...
                registration details. Other inquiries should be directed to
                Genzan sensei at{" "}
          ...
          <article class="block__content">
            <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3">
              ...
              <p class="block__copy">
                ...
                school") sword art not taught outside Japan until recently. The
                United States Tamiya Ryu Iaijutsu Orgranization is the only
                official group practicing this art in America.
              </p>
              <p>
        ...
        <div class="col-xs-12 col-md-6 col-md-offset-0">
          <article class="block__content">
            ...
            <p class="block__copy">
              ...
              sudden attack by the attacker against the defender using a single,
              swift stroke of the sword and seeks to master the various
              principles of drawing, re-sheathing and using the sword.
            </p>
            <p class="block__copy">
              Furthermore, iaijutsu is a martial way (budo) as it practiced with
              a humble and modest heart and continually trains the spirit.
            </p>
          </article>
        </div>
        <div class="col-xs-12 col-md-6 col-md-offset-0">
          <article class="block__content">
            ...
            <p class="block__copy">
              ...
              in the Tensho period (1573-1591) by its founder, Tamiya Heibei
              Narimasa. Narimasa, together with Katayama Hoki no kami Hisayasu
              (the founder of Hoki Ryu) and Sekiguchi Jushin (the founder of
              Sekiguchi Ryu) were pupiles of Hayashizake Jinsuke Shigenobu, the
              founder of iaijutsu.
            </p>
            <p class="block__copy">
  ...
  <div class="block block--darkest row center">
    <div class="col-xs-10 col-xs-offset-1">
      ...
      <p class="block__copy">
        ...
        the practice and performance of kata (pre-arranged techniques).
        Techniques are practiced with the philosophy of the "sword which gives
        life (Katsujin no Ken)," as opposed to the "sword which takes life
        (Satsujin no Ken)."
      </p>
      <p class="block__copy">
    ...
    <div class="block__content ki-ken-tai-section">
      ...
      <div class="col-xs-8 col-xs-offset-2 center col-sm-4 col-sm-offset-0">
        <div class="ki-ken-tai">
          ...
          <p class="ki-ken-tai__body">
            Sword. The sword of Tamiya Ryu is one that gives life or katsujin no
            ken.
          </p>
        </div>
      </div>
